...
create table user_address (
        ...
        constraint fk_account_id_user_address foreign key (account_id) references accounts(account_id) 
);
...
create table user_history (
        ...
        constraint fk_user_ordered_wine_account_id foreign key (account_id) references accounts(account_id), 
        constraint fk_user_ordered_wine_wine_id foreign key (wine_id) references wines(wine_id) 
);
